<?php
function w2dwp_job_taxonomy_list( $atts, $content = null ) {
	$atts = shortcode_atts( 
		array(
...
add_shortcode( 'job_location_list', "w2dwp_job_taxonomy_list" );
function w2dwp_list_job_by_location( $atts, $content = null ) {
...
add_shortcode( 'jobs_by_location', 'w2dwp_list_job_by_location' );
